...
struct Effect {
    enum Type { HLASER, VLASER, EXPLOSION, SPIKES, DOTFIELD, STARFIELD} type;
    int x, y;
    int lifetime;       
    int duration;       
    bool active;
...
void spawnEffect(Effect::Type t) {
    ...
    switch (t) {
        ...
        case Effect::SPIKES:
            ...
            e.y = SCREEN_H - 1;
            break;
        case Effect::DOTFIELD:
        case Effect::STARFIELD:
            e.x = e.y = 0;
            break;
    }
    effects.push_back(e);
...
void handleInput() {
    while (_kbhit()) {
        ...
        switch (c) {
            ...
            case '5': spawnEffect(Effect::DOTFIELD); break;
            case '6': spawnEffect(Effect::STARFIELD); break;
